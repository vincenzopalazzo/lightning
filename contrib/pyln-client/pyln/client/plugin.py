...
class Plugin(object):
    ...
    def add_method(self, name: str, func: Callable[..., Any],
                   ...
                   long_desc: Optional[str] = None) -> None:
    ...
    def add_flag_option(self, name: str, description: str) -> None:
    ...
    def async_method(self, method_name: str, category: Optional[str] = None,
                     desc: Optional[str] = None,
                     long_desc: Optional[str] = None) -> NoneDecoratorType:
    ...
    def method(self, method_name: str, category: Optional[str] = None,
               desc: Optional[str] = None,
               long_desc: Optional[str] = None) -> JsonDecoratorType:
    ...
    def _getmanifest(self) -> JSONType:
        methods = []
        hooks = []
